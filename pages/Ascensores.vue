      ...
      >
        ...
        <div class="flex justify-between">
          ...
          <nuxt-link
            ...
            :to="`/osm/${ascensores.lat}/${ascensores.lon}`"
          >
            Ir al mapa
          </nuxt-link>
          <!-- <Osm v-if="ascensores.lat && ascensores.lon" :lat="ascensores.lat" :lon="ascensores.lon" /> -->
        </div>
      </div>
    </div>
  </div>
