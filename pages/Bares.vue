  ...
  <div class="justify-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 md:mx-10 sm:mx-0 md:gap-5 gap-y-5 justify-center md:px-0 px-2">
      <div
        ...
        :key="atractivo.id"
      >
      <p class="text-white text-xl mx-2">Sector: {{ atractivo.ubication }}</p>
...
export default {
  ...
  methods: {
    listEscaleras() {
      axios
        this.$axios.get("/api-bares") // Va a web.php por defecto y busca el nombre de la ruta que arroja el JSON
