<template>
  <div>
    <div>
      ...
      <p v-else>GPS: No</p>
      <p v-if="latitude">GPS: {{ latitude }}, {{ longitude }}</p>
      <p>WAYPOINTS
        {{ waypoints }}</p>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      waypoints: [
        // [-33.032527, -71.630758], // Plaza Sotomayor
        // [-33.4757888,  -70.6445312], // Muelle Barón
      ],
      waypoints2: [],
      latitude: null,
      longitude: null,
  ...
  methods: {
    ...
    updateWaypoints() {
      ...
      // if (this.userLocation) {   //SI ESPERO LA COMPROBACION NO FUNCIONA
        this.waypoints = [

          [this.routeParams.lat, this.routeParams.lon], // PUNTO LABRUJULA 
          // [-33.037773, -71.634158]
